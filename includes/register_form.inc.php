				...
				<form id="register_hotel" method="POST" action="../includes/register.inc.php" enctype="multipart/form-data">
					<div class="form-row">
						<div class="mb-3">
							...
							<input type="text" class="form-control" id="hName" name="hName" placeholder="Achintha Hotel" required>
						</div>
						<div class="mb-3">
							<label for="email">Email</label>
							<input type="email" class="form-control" id="hEmail" name="hEmail" placeholder="Achintha@gmail.com" required>
						</div>
						<div class="mb-3">
							<label for="pwd">Password</label>
					...
					<div class="mb-3">
						...
						<input type="text" class="form-control" id="hAdd" name="hAdd" placeholder="05 Grand Hotel Rd, Nuwara Eliya 22200" required>
					</div>
					<div class="form-floating">
						<textarea class="form-control" id="hDesc" name="hDesc" style="height: 100px; resize: none;" required></textarea>
						<label for="desc">Description</label>
						<div id="descHelp" class="form-text">Share a little about your hotel, make it interesting!</div>
					</div>
