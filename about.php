...
<body>
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="index.html">CTO<span>Travel Organizer</span></a>
 ...
 <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/ganga.jpg');">
...
<div class="item">
  <div class="testimony-wrap py-4">
    ...
    <p class="mb-4">FDo you love exploring new places and trying new things? Or do you need a bit of a nudge to step outside your comfort zone? Either way, creative sayings about adventure can help you express yourself. Whether you're looking to share your passion for adventure or you're searching for sayings to remind you that wonderful things can happen when you try something new, the following adventure quotes will help you soar.</p>
    <div class="d-flex align-items-center">
     <div class="user-img" style="background-image: url(images/person.jpg)"></div>
     <div class="pl-3">
      <p class="name">Imesh Ekanayaka</p>
    ...
    <div class="col-md pt-5 border-left">
      <div class="ftco-footer-widget pt-md-5 mb-4">
       ...
       <div class="block-23 mb-3">
         <ul>
           <li><span class="icon fa fa-map-marker"></span><span class="text">Colomobo 6 </span></li>
