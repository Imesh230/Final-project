        ...
        <div class="section">
            <table>
                ...
                <tr>
                    ...
                    <td>RS <?= $package->showPrice($packageId) ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td>Sub-Total:</td>
                    <td>RS <?= $payment->getSubtotal($package->showPrice($packageId)) ?></td>
                </tr>
                <tr>
                    <td>Booking Fee:</td>
                    <td>RS <?= $payment->getBookingFee() ?></td>
                </tr>
                <tr style="background-color:#ECECEC;">
                    <td><b>Total Amount Payable:</b></td>
                    <td><b>RS <?= $payment->getFinalPrice($package->showPrice($packageId)) ?></b></td>
                </tr>
            </table>
        </div>
        <div>
