				...
				<div class="card">
					<div class="card-header">
						...
						<span class="">
							...
							<a href="memberspdf.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i
					...
					<div class="card-body">
						...
						<table class="table table-bordered table-condensed table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$tbl_member = $conn->query("SELECT * FROM `customer` ORDER BY `customer`.`custName` ASC");
								while($row=$tbl_member->fetch_assoc()):
								?>
								<tr>
									
									<td class="text-center"><?php echo $i++ ?></td>
									<td class="">
										 <p><b><?php echo $row['custUid'] ?></b></p>
										 
									</td>
									<td class="">
										 <p><b><?php echo ucwords($row['custName']) ?></b></p>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary view_member" type="button" data-custUid="<?php echo $row['custUid'] ?>" >View</button>
										<button class="btn btn-sm btn-outline-danger delete_member" type="button" data-custUid="<?php echo $row['custUid'] ?>">Delete</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
